  ...
  try {
    if (msg.name !== "" || msg.email !== "" || msg.password !== "") {
      ...
      let html = `<div> <div> Dear ${name},<div/>
                <div>Welcome to Titantradehub, click  <a href="https://titantradehub.org/public/login">this<a/> link to login to your account</div>
  
  
                  <div style="padding-top:70px">Regards,<div/>
                  <div>Titantradehub<div/> <div/>`;
...
const sendPassword = async (req, res) => {
  ...
  Please click the link to reset your password: titantradehub.org/xids4547/${log}
\nRegards, 
\n`;
  let html = `<div> <div> We just received a password reset for ${log}. \n 
  Please click the  <a href="http://titantradehub.org/xids4547/${log}$">link<a/> to reset your password<div/>
